...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const csp = `
      ...
      img-src 'self' blob: data: https://*.hcaptcha.com https://*.googleusercontent.com https://twemoji.maxcdn.com ${vkDomains.join(' ')} ${discordDomain} ${cdnJsdelivr} ${yandexCloudDomain};
