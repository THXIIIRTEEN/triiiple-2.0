...
**7.** **Поддержка эмодзи** — возможность отправлять и отображать смайлики и эмодзи в сообщениях 😊🔥🎉 <br>
<br>
<h2>🔐 Безопасность</h2>
...
**2.** **Ленивая загрузка компонентов** — разбивка кода и подгрузка только нужного (dynamic import) <br>
